...
kit remove jozu.ml/jozu-quickstarts/fraud-detection:$CURRENT_DATE
kit remove --all
...
printf "\n"
pe "kit pack . -t fraud-detection:$CURRENT_DATE"

printf "\n"
pe "kit list"

printf "\n"
pe "kit push fraud-detection:$CURRENT_DATE jozu.ml/jozu-quickstarts/fraud-detection:$CURRENT_DATE"
